...
const generatedModel = {
  ...
  init() {
    ...
    generatedModel.setModel(db.connection.model("Organization", organizationSchema));
  ...
  *
  */
  async findBy_partnership(key) {
    return await generatedModel.model.find({ '_partnership' : key});
  },
