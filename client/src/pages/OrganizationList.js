...
class OrganizationList extends Component {
  ...
  confirmDialogDelete(id) {
    this.props.actionsOrganization.deleteOrganization(this.state.idDelete).then(data => {
      this.props.actionsOrganization.loadOrganizationList();
      this.setState({ openDialogDelete: false, idDelete: null });
    });
  }
            ...
            {this.props.list.map(row => (
              <TableRow key={row._id}>
                <TableCell component="th" scope="row">
                  <Link to={"/organizations/" + row._id} key={row._id}>
                    {row._id}
                  </Link>
                </TableCell>
...
function mapStateToProps(state, ownProps) {
  return {
    list: state.OrganizationListReducer.listOrganization
  };
}
