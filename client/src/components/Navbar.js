    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">bChain</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/organizations">
            <ListItem button key="Organization">
              ...
              <ListItemText className="menu-text" primary="Organization" />
            </ListItem>
          </Link>{" "}            
           <Link to="/partnerships">
            <ListItem button key="Partnership">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Partnership" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
